// Adds Gloablly accessible Searchblox object with configs into JS
var searchblox = {};

Drupal.behaviors.searchblox = {
  attach:function ( context , settings ) {
    searchblox = settings.searchblox;
  }
}

jQuery(document).ready(function($){
  $(".searchblox-div").removeClass("container-inline");
  $(".searchblox-div").find(".container-inline").removeClass("container-inline");
});
