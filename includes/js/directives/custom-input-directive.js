...
angular.module('searchblox.custominput',[])
    ...
    return {
        ...
        template: '<div class="{{inputstyle.name}}">' +
            ...
            '    <ul class="dropdown-menu" id = "searchblox-menu">' +
        ...
        controller: ["$scope", "$attrs", "$element", function ($scope, $attrs, $element) {
            ...
            $scope.matchAll = function () {
                ...
                $scope.searchParam = jQuery.trim($scope.searchParam.replace(/ OR /gi, ' '));
                $scope.searchParam = ($scope.searchParam.replace(/ /gi, ' AND '));
                $scope.onsearch();

            };
            $scope.matchAny = function () {
                $scope.searchParam = jQuery.trim($scope.searchParam.replace(/ AND /gi, ' '));
